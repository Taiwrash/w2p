...
// Generate a demo API key using the browser's crypto API
const generateKey = () => `sk_pro_${crypto.randomUUID().replace(/-/g, '').slice(0, 32)}`;
                ...
                <div style={{ marginTop: '20px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '10px', marginTop: '8px' }}>
                        <input
                            ...
                            value={apiKey}
                            readOnly
                            style={{ flex: 1, padding: '10px', borderRadius: '6px', border: '1px solid var(--glass-border)', background: 'var(--bg-dark)', color: '#fff' }}
                        />
                        <button
                    ...
                    <button
                        className="btn btn-secondary"
                        style={{ marginTop: '10px', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', fontSize: '0.85rem' }}
